...
public static class CommonReferences
{
    ...
    public static GameObject selectionHandleObject { get; private set; }
    ...
    public static ObjectSelection objectSelection { get; private set; }
    ...
    static CommonReferences()
    {
        ...
        selectionHandleObject = GameObject.Find("Tool Handle");
        ...
        selectionHandle = selectionHandleObject.GetComponent<SelectionHandle>();
    }
}
